...
class SdkError {
    public static $errorDescArray=
       ...
       "INVALID_GASPRICE_ERROR"=>array(11049 => "GasPrice must be between 0 and max(int64)"),
       "INVALID_FEELIMIT_ERROR"=>array(11050 => "FeeLimit must be between 0 and max(int64)"),
